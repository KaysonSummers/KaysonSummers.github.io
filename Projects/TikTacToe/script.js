...
function checkWin(){
    ...
    } else if (a1 == b1 && b1 == c1 && c1 == 'X'){
        document.getElementById('winner').innerHTML = "X wins!!"
    } else if(a2 == b2 && b2 == c2 && c2 == 'X'){
        document.getElementById('winner').innerHTML = "X wins!!"
    } else if(a3 == b3 && b3 == c3 && c3 == 'X'){  
        document.getElementById('winner').innerHTML = "X wins!!"
    } else if (b1 == b2 && b2 == b3 && b3 == 'X'){
        document.getElementById('winner').innerHTML = "X wins!!"
    } else if (c1 == c2 && c2 == c3 && c3 == 'X'){
        document.getElementById('winner').innerHTML = "X wins!!"
    } else if (a1 == b2 && b2 == c3 && c3 =='X'){
        document.getElementById('winner').innerHTML = "X wins!!"
    } else if (c1 == b2 && b2 == a3 && a3 == 'X'){
        document.getElementById('winner').innerHTML = "X wins!!"
    } else if(a1 == a2 && a2 == a3 && a3 == 'O'){
        document.getElementById('winner').innerHTML = "O wins!!"
    } else if (a1 == b1 && b1 == c1 && c1 == 'O'){
        document.getElementById('winner').innerHTML = "O wins!!"
    } else if(a2 == b2 && b2 == c2 && c2 == 'O'){
        document.getElementById('winner').innerHTML = "O wins!!"
    } else if(a3 == b3 && b3 == c3 && c3 == 'O'){
        document.getElementById('winner').innerHTML = "O wins!!"
    } else if (b1 == b2 && b2 == b3 && b3 == 'O'){
        document.getElementById('winner').innerHTML = "O wins!!"
    } else if (c1 == c2 && c2 == c3 && c3 == 'O'){
        document.getElementById('winner').innerHTML = "O wins!!"
    } else if (a1 == b2 && b2 == c3 && c3 =='O'){
        document.getElementById('winner').innerHTML = "O wins!!"
    } else if (c1 == b2 && b2 == a3 && a3 == 'O'){
        document.getElementById('winner').innerHTML = "O wins!!"
    }
}
